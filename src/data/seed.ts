...
export const initialLiveSessions: LiveSession[] = [
  {
    id: "meet-seed-live-1",
    courseId: "c6",
    courseTitle: "Sigma Web Development Masterclass",
    trainerId: "u-trainer-official",
    trainerName: "Raj Tiwari",
    title: "Live Fullstack Architecture & React 19 Engine Lab",
    description: "Hands-on live coding, state orchestration with Zustand, and interactive Q&A session with Raj Tiwari.",
    scheduledAt: new Date(Date.now() - 15 * 60000).toISOString(),
    durationMinutes: 90,
    googleMeetUrl: "https://meet.google.com/raj-tiwa-meet",
    meetingCode: "raj-tiwa-meet",
    joinUrl: "https://meet.google.com/raj-tiwa-meet",
    platform: "google-meet",
    status: "live",
    attendeeCount: 14,
    attendees: ["u-trainer-official"],
    isInstant: false
  },
  {
    id: "meet-seed-upcoming-1",
    courseId: "c-dsa",
    courseTitle: "Striver A2Z DSA Sheet - Complete Placement Masterclass",
    trainerId: "u-trainer-striver",
    trainerName: "Raj Vikramaditya (Striver)",
    title: "Live Problem Solving: Dynamic Programming on Grids & Subsequences",
    description: "Deep-dive live walkthrough of Hard LeetCode DP problems, recurrence relations, and space optimization.",
    scheduledAt: new Date(Date.now() + 4 * 3600000).toISOString(),
    durationMinutes: 75,
    googleMeetUrl: "https://meet.google.com/str-iver-dsa",
    meetingCode: "str-iver-dsa",
    joinUrl: "https://meet.google.com/str-iver-dsa",
    platform: "google-meet",
    status: "upcoming",
    attendeeCount: 0,
    attendees: []
  ...
  {
    id: "meet-seed-upcoming-2",
    courseId: "c-sql",
    courseTitle: "CS50's Introduction to Databases with SQL",
    trainerId: "u-trainer-malan",
    trainerName: "David J. Malan",
    title: "Interactive Office Hours: Index B-Trees & Relational Query Optimization",
    description: "Harvard CS50 live doubt clearing on SQL execution plans, normalization, and ACID transaction isolation.",
    scheduledAt: new Date(Date.now() + 24 * 3600000).toISOString(),
    durationMinutes: 60,
    googleMeetUrl: "https://meet.google.com/cs5-sql-live",
    meetingCode: "cs5-sql-live",
    joinUrl: "https://meet.google.com/cs5-sql-live",
    platform: "google-meet",
    status: "upcoming",
    attendeeCount: 0,
    attendees: []
